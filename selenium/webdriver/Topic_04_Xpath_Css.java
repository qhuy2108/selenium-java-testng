...
public class Topic_04_Xpath_Css {
    ...
    public void TC_02_Invalid_Email_Address() {
        ...
        driver.findElement(By.id("txtFirstname")).sendKeys("donal");
    ...
    public void TC_03_Incorrect_Confirm_Email() {
        ...
        driver.findElement(By.id("txtFirstname")).sendKeys("donal");
        driver.findElement(By.id("txtEmail")).sendKeys("joy@99.com");
        driver.findElement(By.id("txtCEmail")).sendKeys("joy@99.comm");
    ...
    public void TC_05_Incorrect_Confirm_Password() {
        ...
        driver.findElement(By.id("txtCEmail")).sendKeys("joy@99.comm");
        driver.findElement(By.id("txtPassword")).sendKeys("123456");
        driver.findElement(By.id("txtCPassword")).sendKeys("1123456");
        driver.findElement(By.id("txtPhone")).sendKeys("0911111111");
        driver.findElement(By.xpath("//button[@type='submit']")).click();
    ...
    public void TC_06_Invalid_Phone_Number() {
        ...
        driver.findElement(By.id("txtPassword")).sendKeys("123456");
        driver.findElement(By.id("txtCPassword")).sendKeys("1123456");
        driver.findElement(By.id("txtPhone")).sendKeys("1911111111");
        driver.findElement(By.xpath("//button[@type='submit']")).click();

        Assert.assertEquals(driver.findElement(By.id("txtPhone-error")).getText(), "Số điện thoại bắt đầu bằng: 09 - 03 - 012 - 016 - 018 - 019 - 088 - 03 - 05 - 07 - 08");

        driver.findElement(By.id("txtPhone")).clear();
        driver.findElement(By.id("txtPhone")).sendKeys("091111111122");
        driver.findElement(By.xpath("//button[@type='submit']")).click();
